//! The download client implementations for Malachite engine
...
/// Based on AutoSealClient from reth.
///
...
/// blocks in memory.
#[derive(Debug, Clone)]
pub struct MalachiteClient {
    storage: Storage,
}

impl MalachiteClient {
...
impl HeadersClient for MalachiteClient {
...
impl BodiesClient for MalachiteClient {
...
impl DownloadClient for MalachiteClient {
